...
class LocalPlanner:
    ...
    def get_goal_state_set(self, goal_index, goal_state, waypoints, ego_state):
        ...
        if (goal_index != len(waypoints) -1):
            x_goal = waypoints[goal_index][0]
            y_goal = waypoints[goal_index][1]
            x_prev = waypoints[goal_index-1][0]
            y_prev = waypoints[goal_index-1][1]
        else:  
            x_goal = waypoints[goal_index-1][0]
            y_goal = waypoints[goal_index-1][1]
            x_prev = waypoints[goal_index-2][0]
            y_prev = waypoints[goal_index-2][1]

        delta_x = x_goal - x_prev
        delta_y = y_goal - y_prev
